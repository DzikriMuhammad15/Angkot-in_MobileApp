            ...
            <MenuProvider>
                <ScrollView style={styles.screenContainer}>
                    <View style={styles.kuningContainer}>
                        <TouchableOpacity style={styles.logoBackContainer}>
                            ...
                            <View style={styles.containerInputanDalam}>
                                <Menu style={styles.menuAwal}>
                                    <MenuTrigger style={styles.triggerAwal}>
                                        <Text style={styles.textTriggerAwal}>{titikAwal ? titikAwal : "Open menu"}</Text>
                                    </MenuTrigger>
                                    <MenuOptions style={styles.menuOptions}>
                                        <MenuOption style={styles.menuOption} onSelect={clickAwalITB} ><Text style={styles.menuOptionText}>Institut Teknologi Bandung</Text></MenuOption>
                                        <MenuOption style={styles.menuOption} onSelect={clickAwalSMAN3}><Text style={styles.menuOptionText}>SMAN 3 Bandung</Text></MenuOption>
                                        <MenuOption style={styles.menuOption} onSelect={clickAwalSMAN8}><Text style={styles.menuOptionText}>SMAN 8 Bandung</Text></MenuOption>
                                    </MenuOptions>
                                </Menu>
                                {titikAwal ? (<Menu style={styles.menuAwal}>
                                    <MenuTrigger style={styles.triggerAkhir}>
                                        <Text style={styles.textTriggerAwal}>{titikDestinasi ? titikDestinasi : "Open menu"}</Text>
                                    </MenuTrigger>
                                    <MenuOptions style={styles.menuOptions}>
                                        {titikAwal == "Institut Teknologi Bandung" ? null : (<MenuOption style={styles.menuOption} onSelect={clickAkhirITB}><Text style={styles.menuOptionText}>Institut Teknologi Bandung</Text></MenuOption>)}
                                        {titikAwal == "SMAN 3 Bandung" ? null : (<MenuOption style={styles.menuOption} onSelect={clickAkhirSMA3}><Text style={styles.menuOptionText}>SMAN 3 Bandung</Text></MenuOption>)}
                                        {titikAwal == "SMAN 8 Bandung" ? null : (<MenuOption style={styles.menuOption} onSelect={clickAkhirSMA8}><Text style={styles.menuOptionText}>SMAN 8 Bandung</Text></MenuOption>)}
                                    </MenuOptions>
                                </Menu>) : (<View style={styles.triggerAkhir}>
                                    <Text style={styles.textTriggerAwal}>Open menu</Text>
                                </View>)}
                            </View>
                        </View>
                    </View>
                    {titikAwal ? (<ImageBackground style={styles.putihContainer} source={imagePaths[imagePath]}>
                        {titikDestinasi ? (<TouchableOpacity style={styles.confirmOrderButton} onPress={addDocToFirestore}><Text style={styles.confirmOrder}>Confirm order</Text></TouchableOpacity>) : null}
                    </ImageBackground>) : (<View style={styles.putihContainer}>
