    ...
    return (
        <ScrollView style={styles.screenContainer}>
            <View style={styles.contentContainer}>
                ...
                <Text style={styles.thankYou}>Thank you for using <Text style={styles.angkotin}>Angkotin</Text></Text>
                <TouchableOpacity style={styles.doneButton} onPress={() => navigation.replace("mapScreen")}>
