...
export default function TermScreen({ navigation }) {
    ...
    return (
        <ScrollView style={styles.screenContainer}>
            <TouchableOpacity style={styles.logoBackContainer} onPress={backToEmailScreen}>
                <Image source={require("../assets/logoBack.png")} style={styles.logoBack} />
            </TouchableOpacity>
            <View style={styles.contentBesarContainer}>
                <Image source={require('../assets/logoProfile.png')} style={styles.logoProfile} />
                <View style={styles.byTappingContainer}>
                    <Text style={styles.byTapping}>By tapping the arrow below, you agree to Angkotin’s Terms of Use and acknowledge that you have read the Privacy Policy</Text>
                </View>
                <View style={styles.checkTheBoxContainer}>
                    <Text style={styles.checkTheBox}>Check the box to indicate that you are atleast 18 years of age, agree to the Terms & Conditions and acknowledge the Privacy Policy.</Text>
                </View>
            </View>
            <TouchableOpacity style={styles.nextButton} onPress={goToPaymentMethodScreen}>
